class CommentService {
    ...
    getAllComments(character) {
        ...
        .catch((error) => {alert(`There was an issue getting all this character's comments due to ${error}. Please try again.`)});
    };
    ...
    getUserComments() {
        ...
        .catch((error) => {alert(`There was an issue getting the comments for your collection characters due to ${error}. Please try again.`)});
    };
    ...
    addCharacterComment(description, characterId, userId, name) {
        ...
        .catch(error => {alert(`There was an issue adding this description to your character, ${name}, due to ${error}. Please try again.`)});
    };
    ...
    editCharacterComment(editDescription, characterId, userId, commentId, characterName) {
        ...
        .catch(error => {alert(`There was an issue adding this description to your character, ${characterName}, due to ${error}. Please try again.`)});
    };
